...
function filterMatriculaInput(event) {
  const clean = event.target.value.toUpperCase().replace(/[^A-Z0-9-]/g, '').slice(0, 30)
  form.matricula = clean
  if (errors.value.matricula) delete errors.value.matricula
}
...
function validate() {
  ...
  const mErr = validateMatricula(form.matricula)
      ...
      <form @submit.prevent="handleSubmit">
        <div class="modal-body">
          ...
          <div class="student-photo-section">
            ...
            <div class="photo-info-box">
              ...
              <p class="photo-desc">
                Captura con la cámara web o del celular para la credencial y asistencias.
              </p>
        ...
        <div class="modal-footer">
          ...
          <button
            ...
            :disabled="isSaving"
          >
            {{ isSaving ? 'Guardando...' : (editingId ? 'Actualizar Alumno' : 'Guardar Alumno') }}
          </button>
        </div>
      </form>
    </div>
